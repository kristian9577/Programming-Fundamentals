...
public class PriceChangeAlert {
    public static void main(String[] args) {
        ...
        int pricesCount = Integer.parseInt(scan.nextLine());
        double significanceThreshold = Double.parseDouble(scan.nextLine()) * 100.0;
        double previousPrice = Double.parseDouble(scan.nextLine());

        for (int i = 0; i < pricesCount - 1; i++)
        {
            double currentPrice = Double.parseDouble(scan.nextLine());
